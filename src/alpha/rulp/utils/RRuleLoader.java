...
import static alpha.rulp.rule.Constant.F_LIST_STMT_GENERATE_TREE;
...
public class RRuleLoader implements IRObjectLoader {
	...
	public void load(IRInterpreter interpreter, IRFrame frame) throws RException, IOException {
		...
		RulpUtil.addFrameObject(frame, new XRFactorListStmtGenerateTree(F_LIST_STMT_GENERATE_TREE));
