...
import static alpha.rulp.rule.Constant.F_PRINT_ENTRY_REF;
...
import alpha.rulp.ximpl.factor.XRFactorPrintEntryRef;
...
//		RulpUtil.addFrameObject(systemFrame, new XRFactorListObj(F_LIST_OBJ));
		...
		RulpUtil.addFrameObject(systemFrame, new XRFactorPrintEntryRef(F_PRINT_ENTRY_REF));
