...
public class XREntryQueueOrder implements IREntryQueue {
	...
	static class XREntryCounter implements IREntryCounter {
		...
		public XREntryCounter(XREntryQueueOrder queue) throws RException {
			_updateEntryCount(queue);
		}

		protected void _updateEntryCount(XREntryQueueOrder queue) throws RException {
