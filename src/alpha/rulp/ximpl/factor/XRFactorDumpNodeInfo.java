...
public class XRFactorDumpNodeInfo extends AbsAtomFactorAdapter implements IRFactor, IRuleFactor {

	public XRFactorDumpNodeInfo(String factorName) {
		super(factorName);
	}
	...
	public IRObject compute(IRList args, IRInterpreter interpreter, IRFrame frame) throws RException {
		...
		out.add(StatsUtil.printNodeInfo(model));
